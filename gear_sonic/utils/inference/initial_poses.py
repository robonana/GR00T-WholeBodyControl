...
# 64-dim motion token for the water_bottle VLA start pose.
# Source: outputs/water_bottle episode_000033, frame 0, action.motion_token.
# CHECKPOINT-SPECIFIC: this value must be updated if the SONIC checkpoint changes.
LATENT_INITIAL_MOTION_TOKEN = np.array(
    [
        -0.0625, -0.0625, -0.1875, -0.1875, -0.1875,  0.0000,  0.0625,
         0.1875,  0.1250, -0.0625,  0.0625,  0.0000, -0.1875, -0.2500,
        -0.2500, -0.0625,  0.0000, -0.0625,  0.0000, -0.1250, -0.0625,
        -0.2500,  0.0000, -0.2500,  0.0000,  0.0625,  0.0625, -0.0625,
         0.1875,  0.1875,  0.2500, -0.0625,  0.0000,  0.1875, -0.1250,
         0.0000, -0.1250, -0.1250,  0.1875,  0.0000, -0.0625,  0.0000,
         0.0000, -0.0625, -0.0625, -0.0625,  0.0625, -0.0625,  0.0625,
         0.0000,  0.1250,  0.0000,  0.1250, -0.0625,  0.0000,  0.0000,
         0.0625,  0.0625,  0.0625,  0.0625,  0.0625,  0.0625,  0.1250,
         0.0625,
    ],
    dtype=np.float32,
)
