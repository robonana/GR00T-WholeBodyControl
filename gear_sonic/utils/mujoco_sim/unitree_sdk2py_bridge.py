...
class UnitreeSdk2Bridge:
    ...
    def __init__(self, config):
        ...
        # Create command locks BEFORE registering the DDS subscribers: Init()
        # starts a reader thread immediately, and if the publisher (C++ deploy)
        # is already sending, the handler can fire before these locks exist.
